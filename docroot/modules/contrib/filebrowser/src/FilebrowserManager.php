  ...
  public function addFormExtraFields(&$form, $form_state, $node = null, $isConfigForm = false) {
   ...
   //  '#weight' => $weight++,
    ...
    $form['filebrowser']['adhocsetting']['external_host'] = [
      ...
      //'#default_value' => isset($nodeValues->externalHost) ? $nodeValues->externalHost : (isset($config['adhocsetting']['externalhost']) ? $config['adhocsetting']['externalhost'] : ''),
      '#default_value' => $nodeValues->externalHost ?? $config['adhocsetting']['external_host'],
      ];
