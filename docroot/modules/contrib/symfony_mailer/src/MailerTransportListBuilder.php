 ...
 */
class MailerTransportListBuilder extends ConfigEntityListBuilder {
  ...
  public function render() {
    ...
    $build['transport_add_form'] += $this->formBuilder->getForm('Drupal\symfony_mailer\Form\TransportAddButtonForm');
